...
class EnvidosDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for obj in _xml.iter('objects'):
            ...
            boxes.append(bndbox)
            classes.append(category_to_id[name]) # start from 0
            iscrowds.append(0)
    ...
    def __init__(self, mode, dataset=None, root=None):
        ...
        if dataset is not None:
            ...
            for idx in range(len(dataset)):
                ...
                # scale up image and keep cxcywh format
                ...
                # convert boxes format from xyxy => xywh
                # boxes = anno['orig_boxes']
                # xmin, ymin, xmax, ymax = boxes.unbind(1)
                # anno['boxes'] = torch.stack((xmin, ymin, xmax - xmin, ymax - ymin), dim=1)
