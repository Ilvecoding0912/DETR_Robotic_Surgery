...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./outputs_bb',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda:0',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=7, type=int, metavar='N',
                        help='start epoch')
...
def main(args):
    ...
    if args.eval:
        ...
        print("Save the eval model")
        torch.save(model_without_ddp, 'detr_0040.pth')
        test_stats, coco_evaluator = evaluate(model_without_ddp, criterion, postprocessors,
                                              data_loader_val, base_ds, device, args.output_dir, epoch)
        if args.output_dir:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(model_without_ddp, 'train_01.pth') 
